...
namespace HyperSlackers.MultiHost
{
    ...
    /// <summary>
    /// Minimal interface for a user claim for a multi-tenant <c>DbContext</c> having key type of <c>string</c>.
    /// </summary>
    public interface IUserClaimMultiHostString : IUserClaimMultiHost<string>
    {
    }
