...
namespace HyperSlackers.MultiHost
{
    ...
    /// <summary>
    /// Minimal interface for a user login for a multi-tenant <c>DbContext</c> having key type of <c>string</c>.
    /// </summary>
    public interface IUserLoginMultiHostString : IUserLoginMultiHost<string>
    {
    }
